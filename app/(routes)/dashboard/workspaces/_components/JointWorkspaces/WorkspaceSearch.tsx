    ...
    <form className="flex items-center">
      ...
      <div className="relative w-full">
        ...
        <input
          type="text"
          id="voice-search"
          className="bg-gray-50 border border-gray-300 dark:border-[#656f7d6d] text-gray-900 text-sm rounded-md block w-full px-2.5 h-8 pl-8 pr-8 dark:bg-[#2A2E35] dark:placeholder-gray-400 dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-none placeholder:text-xs "
